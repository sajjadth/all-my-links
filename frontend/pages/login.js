    ...
    swal.fire(
      {
        ...
        text: "Relax and Remember Your Password!",
        icon: "question",
      ...
      <react.Fragment>
        ...
        {this.state.isPageLoading ? (
          ...
          <div className="d-flex flex-column flex-lg-row align-items-center justify-content-center w-100 vh-100 pattern-diagonal-stripes-lg text-bg">
            ...
            <div className="d-flex flex-column justify-content-center align-items-center w-100 vh-100 right-side">
              <div className="bg-glass">
                ...
                >
                  ...
                  <div
                    className="form-check m-1 w-100"
                    onChange={(e) => this.onChangeHandler(e, "rememberMe")}
                  >
                    <input
                  ...
                  {this.state.isLoading ? (
                    ...
                    <button className="btn btn-primary m-1 w-100" type="submit">
                      Log in
                    </button>
                  )}
                </form>
